...
pub trait Summary {
    //must be implemented by all that implement thr traits
...
//this overwrides the default trait implementation
...
//item can be any time that implements the trait
//an alternative to this implementation would be:
//  pub fn notify<T: Summary>(item: &T) {}
//can also force that type must implement both Summary and Display traits
