/*
Below example shows how to use modules within a crate
In this case, we have below modules. Some have sub-modules
...
//from the same level by eat_at_restaurant
mod front_of_house {
...
mod customer {
    ...
    //bringing in the result type into scope
    use std::fmt::Result;
